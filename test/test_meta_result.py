...
class TestMetaResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MetaResult:
        """Test MetaResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaResult`
        """
        model = MetaResult()
        if include_optional:
            return MetaResult(

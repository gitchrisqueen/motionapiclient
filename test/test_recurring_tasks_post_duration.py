...
class TestRecurringTasksPostDuration(unittest.TestCase):
    """RecurringTasksPostDuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecurringTasksPostDuration:
        """Test RecurringTasksPostDuration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurringTasksPostDuration`
        """
        model = RecurringTasksPostDuration()
        if include_optional:
            return RecurringTasksPostDuration(
            )
        else:
            return RecurringTasksPostDuration(
        )
    ...
    def testRecurringTasksPostDuration(self):
        """Test RecurringTasksPostDuration"""

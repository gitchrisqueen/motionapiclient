...
class ListRecurringTasks(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tasks": [RecurringTask.from_dict(_item) for _item in obj.get("tasks")] if obj.get("tasks") is not None else None,
            "meta": MetaResult.from_dict(obj.get("meta")) if obj.get("meta") is not None else None
        })
        return _obj

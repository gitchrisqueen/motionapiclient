...
class Status(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    is_default_status: StrictBool = Field(alias="isDefaultStatus")
    is_resolved_status: StrictBool = Field(alias="isResolvedStatus")
    __properties: ClassVar[List[str]] = ["name", "isDefaultStatus", "isResolvedStatus"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "isDefaultStatus": obj.get("isDefaultStatus"),
            "isResolvedStatus": obj.get("isResolvedStatus")
        })
        return _obj

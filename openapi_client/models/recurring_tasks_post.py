...
class RecurringTasksPost(BaseModel):
    ...
    RecurringTasksPost
    """ # noqa: E501
    frequency: StrictStr = Field(description="Frequency in which the task should be scheduled. Please carefully read how to construct above.")
    deadline_type: Optional[StrictStr] = Field(default='SOFT', alias="deadlineType")
    duration: Optional[RecurringTasksPostDuration] = None
    starting_on: Optional[datetime] = Field(default=None, description="ISO 8601 Date which is trimmed to the start of the day passed", alias="startingOn")
    ideal_time: Optional[StrictStr] = Field(default=None, alias="idealTime")
    schedule: Optional[StrictStr] = Field(default='Work Hours', description="Schedule the task must adhere to")
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name / title of the task")
    workspace_id: StrictStr = Field(alias="workspaceId")
    description: Optional[StrictStr] = None
    priority: StrictStr
    assignee_id: StrictStr = Field(description="The user id the task should be assigned too", alias="assigneeId")
    __properties: ClassVar[List[str]] = ["frequency", "deadlineType", "duration", "startingOn", "idealTime", "schedule", "name", "workspaceId", "description", "priority", "assigneeId"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "duration": RecurringTasksPostDuration.from_dict(obj.get("duration")) if obj.get("duration") is not None else None,
            "startingOn": obj.get("startingOn"),
            "idealTime": obj.get("idealTime"),

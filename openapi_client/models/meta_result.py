...
class MetaResult(BaseModel):
    ...
    MetaResult
    """ # noqa: E501
    next_cursor: Optional[StrictStr] = Field(default=None, description="Returned if there are more entities to return. Pass back with the cursor param set to continue paging.", alias="nextCursor")
    page_size: Union[StrictFloat, StrictInt] = Field(description="Maximum number of entities delivered per page", alias="pageSize")
    __properties: ClassVar[List[str]] = ["nextCursor", "pageSize"]

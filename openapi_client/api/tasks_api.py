...
class TasksApi:
    ...
    def tasks_controller_get(
        ...
        label: Annotated[Optional[StrictStr], Field(description="Limit tasks returned by label on the task")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Limit tasks returned by the status on the task")] = None,
        workspace_id: Annotated[Optional[StrictStr], Field(description="The id of the workspace you want tasks from. If not provided, will return tasks from all workspaces the user is a member of.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Limit tasks returned to a given project")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Limit tasks returned to those that contain this string. Case in-sensitive")] = None,
        assignee_id: Annotated[Optional[StrictStr], Field(description="Limit tasks returned to a specific assignee")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[

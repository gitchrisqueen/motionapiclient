...
conf = usemotion_api_client.Configuration(
    ...
    def __init__(
        ...
        """Constructor
        """
        self._base_path = "https://api.usemotion.com/v1" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'Motion_API_Key' in self.api_key:
            auth['Motion_API_Key'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix('Motion_API_Key', ),
            }
        return auth

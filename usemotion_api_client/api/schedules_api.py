...
class SchedulesApi:
    ...
    @validate_arguments
    def schedules_controller_get_my_schedules(
            self, **kwargs) -> List[Schedule]:  # noqa: E501
        """Get schedules  # noqa: E501

        Get a list of schedules for your user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.schedules_controller_get_my_schedules(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the schedules_controller_get_my_schedules_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.schedules_controller_get_my_schedules_with_http_info(
            **kwargs)  # noqa: E501

    @validate_arguments
    def schedules_controller_get_my_schedules_with_http_info(
        ...
        >>> thread = api.schedules_controller_get_my_schedules_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method schedules_controller_get_my_schedules" % _key)
            _params[_key] = _val
        del _params['kwargs']

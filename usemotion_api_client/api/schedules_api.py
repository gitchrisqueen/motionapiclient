...
class SchedulesApi:
    ...
    def schedules_controller_get_my_schedules(
        ...
        _param = self._schedules_controller_get_my_schedules_serialize(
    ...
    @validate_call
    def schedules_controller_get_my_schedules_without_preload_content(
        self,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
                                Tuple[Annotated[StrictFloat,
    ...
    def _schedules_controller_get_my_schedules_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,

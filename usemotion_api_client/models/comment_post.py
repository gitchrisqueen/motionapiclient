...
class CommentPost(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentPost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentPost:
        """Create an instance of CommentPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentPost.parse_obj(obj)

        _obj = CommentPost.parse_obj({

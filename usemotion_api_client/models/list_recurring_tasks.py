...
class ListRecurringTasks(BaseModel):
    ...
    ListRecurringTasks
    """
    tasks: conlist(RecurringTask) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListRecurringTasks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListRecurringTasks:
        """Create an instance of ListRecurringTasks from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListRecurringTasks.parse_obj(obj)

        _obj = ListRecurringTasks.parse_obj({
            "tasks":

...
class ListComments(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListComments:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListComments:
        """Create an instance of ListComments from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListComments.parse_obj(obj)

        _obj = ListComments.parse_obj({
            "comments":
            [Comment.from_dict(_item) for _item in obj.get("comments")]

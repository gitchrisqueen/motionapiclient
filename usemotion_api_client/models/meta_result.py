...
class MetaResult(BaseModel):
    ...
    __properties = ["nextCursor", "pageSize"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetaResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MetaResult:
        """Create an instance of MetaResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MetaResult.parse_obj(obj)

        _obj = MetaResult.parse_obj({
